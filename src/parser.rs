...
//             tokenize_variable(&mut tokens, &mut current_token, &mut chars, &mut last_token, c);
//         }
...
// }
//
// fn tokenize_variable(mut tokens: &mut Vec<String>, mut current_token: &mut String, mut chars: &mut Peekable<Chars>, last_token: &mut Option<String>, c: char) {
